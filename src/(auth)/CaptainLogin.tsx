    ...
    <View style={styles.container}>
      ...
      <View style={[tw`flex-1 w-full h-full px-3`]}>
        ...
        <View style={[tw`py-5 gap-5`]}>
            ...
            <TouchableOpacity style={[tw`flex items-center w-full`]} onPress={handleSignup}>
              <View style={[tw` py-3 w-6/12 rounded-md`, {backgroundColor: colors.primary}]}>
                {isSubmitting ? (
                  ...
                  <Text style={[tw`text-lg font-medium  text-center`,{fontFamily:'Quicksand-Bold',color:colors.secondary}]}>Login</Text>
                )}
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View >
            <TouchableOpacity onPress={() => {navigation.replace('CaptainSignup')}}>
              <Text style={[tw`${isDark ? "text-gray-300":"text-gray-700"} text-center`,{fontFamily:'Quicksand-VariableFont_wght'}]}>Dont't have an account for captain? Signup</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
